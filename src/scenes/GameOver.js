class Dead extends Phaser.Scene {
    ...
    update() {
        ...
        if (this.fadingIn == false) {
            ...
            this.graveTxt = this.add.text(this.player2.x - 100, this.player2.y - 300, "Press Enter to Ressurect", this.menuConfig2);
            this.graveTxt = this.add.text(this.player2.x - 100, this.player2.y - 450, "Press Left to Die", this.menuConfig2);
        }
    }
